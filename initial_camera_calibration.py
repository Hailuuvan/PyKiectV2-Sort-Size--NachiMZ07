...
savedir = "camera_data/"
savedir_cap = "Captures"
if not os.path.exists(savedir_cap):
    os.makedirs(savedir_cap)
...
images = glob.glob('images_kinect/*.jpg')
...
# Save the images
cv2.imwrite(savedir_cap + 'img1.jpg', img1)
cv2.imwrite(savedir_cap + 'undistorted.jpg', undst)
